...
Deno.serve(async (req: Request) => {
  ...
  let responseTxt;
  await fetch(bulkerReq)
    .then((result) => result.json()
      .then((data) => {
        responseTxt = data;
        return console.log(`Resend API Response Id:${data.id}`)}))
